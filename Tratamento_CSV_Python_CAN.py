...
# Descompactando
if os.path.isfile("data/dados.zip") == True:
    import zipfile
    with zipfile.ZipFile("data/dados.zip", 'r') as zip_ref:
...
for pasta in os.listdir("data"):
    ...
    for file in os.listdir(f"data/{pasta}"):
        ...
        with open(f"data/{pasta}/{file}", mode='r', errors="ignore") as arquivo_csv:
        ...
        with open(f"data/{pasta}/{file}", mode="w", newline="") as arquivo_csv:
